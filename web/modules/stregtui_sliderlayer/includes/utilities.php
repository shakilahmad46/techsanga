<?php
function stregtui_sliderlayer_datatransition(){
...
function stregtui_sliderlayer_dataeasing_slide(){
...
function stregtui_sliderlayer_dataeasing(){
    return array(
        'Linear.easeNone' => 'Linear.easeNone',
...
function stregtui_sliderlayer_dataendeasing(){
...
function stregtui_sliderlayer_incomingclasse(){
...
function stregtui_sliderlayer_outgoingclasses(){
...
function stregtui_sliderlayer_captionclasses(){
...
function stregtuiGetArrAnimations(){
    $arrAnimations = array();
 ...
 function stregtuiGetArrEndAnimations(){
        $arrAnimations = array();
        $arrAnimations['disable-1'] = array('handle' => '-----------------------------------', 'disable'=>true);
        $arrAnimations['disable-2'] = array('handle' => '- VERSION 5.0 ANIMATIONS -', 'disable'=>true);
        $arrAnimations['disable-3'] = array('handle' => '-----------------------------------', 'disable'=>true);
...
function stregtui_defined_select($name, $options, $class = null) {
...
function stregtui_sliderlayer_field_upload_slider(){
    global $base_url;
    $_id = stregtui_sliderlayer_makeid(10);
    ob_start();
    ?>
    <div class="gva-upload-input field-upload-background-slider" data-id="<?php print $_id; ?>">
        ...
        <img class="stregtui-image-demo" id="gva-upload-<?php print $_id; ?>-demo" src="" />
        <a class="stregtui-field-upload-remove btn-delete" data-src="">Remove</a>
...
function stregtui_sliderlayer_field_upload_layer(){
    global $base_url;
    $_id = stregtui_sliderlayer_makeid(10);
    ob_start();
    ?>
    <div class="gva-upload-image gva-upload-image-layer" id="gva-upload-<?php print $_id; ?>">
        <form class="upload-image-layer" id="upload-<?php print $_id; ?>" method="post" action="<?php print ($base_url . '/admin/structure/stregtui_sliderlayer/upload') ?>" enctype="multipart/form-data">
            <div class="drop">
        ...
        <div class="clearfix"></div>
        <div class="stregtui-box-images">
            <div class="stregtui-box-images-inner">
                <div class="header">
                    Images Upload
