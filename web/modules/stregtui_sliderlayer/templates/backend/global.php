<div class="stregtui-sliderlayer-groupsetting">
  <fieldset class="form-wrapper g-wrapper">
    <div class="stregtui-heading">Global Settings</div>
  ...
  <fieldset class="form-wrapper g-wrapper">
    <div class="stregtui-heading">Layout Style</div>
    <div class="form-global-setting-item">
  ...
  <fieldset class="form-wrapper g-wrapper">
    <div class="stregtui-heading">Navigation Settings</div>
    <div class="form-global-setting-item">
   ...
   <!-- Arrow -->
    <fieldset class="form-wrapper g-wrapper">
      <div class="stregtui-heading">Arrow</div>
      <div class="form-global-setting-item">
    ...
    <fieldset class="form-wrapper g-wrapper">
      <div class="stregtui-heading">Bullets</div>
      <div class="form-global-setting-item">
    ...
    <fieldset class="form-wrapper g-wrapper">
      <div class="stregtui-heading">Disable Progress Bar</div>
      <div class="form-global-setting-item">
