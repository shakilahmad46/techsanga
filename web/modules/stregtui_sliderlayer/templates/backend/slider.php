...
<div id="stregtui_sliderlayer">
  ...
  <div>
    ...
    <div id="stregtui_sliderlayer_main">
      <div class="g-wrapper">
       <div class="stregtui-heading">Slide options</div>
        <table>
          <tr>
            <td width="33%">
          ...
          <tr>
            <td style="position: relative;">
              ...
              <?php print stregtui_sliderlayer_field_upload_slider(); ?>
            </td>
          ...
          <tr>
            <td>
              ...
              <?php print stregtui_defined_select('data_transition', stregtui_sliderlayer_datatransition(),'slide-option'); ?>
            </td>
            <td>
              <label>Slide Easing In</label>
              <?php print stregtui_defined_select('slide_easing_in', stregtui_sliderlayer_dataeasing_slide(),'slide-option'); ?>
            </td>
            <td>
              <label>Slide Easing Out</label>
              <?php print stregtui_defined_select('slide_easing_out', stregtui_sliderlayer_dataeasing_slide(),'slide-option'); ?>
            </td>
          </tr>
       ...
       <div class="clearfix">
        <?php include drupal_get_path('module', 'stregtui_sliderlayer') . '/templates/backend/layers.php'; ?>
      </div>
      </div>
    </div>
  </div>
