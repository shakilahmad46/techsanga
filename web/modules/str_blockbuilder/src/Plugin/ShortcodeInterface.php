 ...
 *
 * @see \Drupal\stregtui_blockbuilder\Annotation\Shortcode
 * @see \Drupal\stregtui_blockbuilder\ShortCode\ShortcodePluginManager
 * @see \Drupal\stregtui_blockbuilder\Plugin\ShortcodeBase
 * @see plugin_api
 */
