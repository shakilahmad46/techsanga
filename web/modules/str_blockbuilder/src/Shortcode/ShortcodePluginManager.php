...
namespace Drupal\stregtui_blockbuilder\Shortcode;
 ...
 *
 * @see \Drupal\stregtui_blockbuilder\Shortcode\Annotation\Shortcode
 * @see \Drupal\stregtui_blockbuilder\Shortcode\ShortcodeInterface
 * @see plugin_api
 */
class ShortcodePluginManager extends DefaultPluginManager {
  ...
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/stregtui_blockbuilder', $namespaces, $module_handler, 'Drupal\stregtui_blockbuilder\Plugin\ShortcodeInterface', 'Drupal\stregtui_blockbuilder\Annotation\Shortcode');
