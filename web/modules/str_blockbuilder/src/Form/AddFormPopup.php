...
class AddFormPopup extends FormBase{
  ...
  */
  ...
  public function submitForm(array &$form, FormStateInterface $form_state){
    ...
    $errors_exist = '';
    if(stregtui_blockbuilder_check_machine(0, $form_state->getValue('body_class'))){
  ...
  protected function dialog($values = array()){
    ...
    $html .= ' <span class="action">( <a class="edit gva-popup-iframe" href="'. Url::fromRoute('stregtui_blockbuilder.admin.edit', array('bid'=>$pid))->toString() .'" title="'. $body_class .'">Edit</a>';
