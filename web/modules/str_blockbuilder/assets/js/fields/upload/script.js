(function($) {
    $(function(){
            ...
            $(this).fileupload({
                add: function (e, data) {
                    ...
                    var jqXHR = data.submit().done(function(data){
                        ...
                        $('#gva-' + $_id + ' .stregtui-image-demo').each(function(){
        ...
        $(document).ready(function () {
             stregtui_load_images();
             stregtui_choose_image();
        });

        function stregtui_load_images(){
            $('.btn-get-images-upload').click(function(){
                $this = $(this);
                $.ajax({
                 url: drupalSettings.stregtui_blockbuilder.get_images_upload_url,
                 type: 'POST',
        ...
        function stregtui_choose_image(){
            ...
            $( ".gva-upload-image" ).delegate( ".btn-choose-image-upload", "click", function() {
                ...
                $(this).parents('.gva-upload-image').find('.stregtui-image-demo').each(function(){
                    $(this).attr('src', file_url_full);
                });

                $(this).parents('.gva-upload-image').find('.stregtui-field-upload-remove').each(function(){
                    $(this).css('display', 'inline-block');
                });
