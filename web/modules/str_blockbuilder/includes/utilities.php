...
function stregtui_blockbuilder_makeid($length = 5){
...
function stregtui_blockbuilder_includes( $path, $ifiles=array() ){
    if( !empty($ifiles) ){
...
/*================================================
                Block for theme
=================================================*/                
function stregtui_blockbuilder_get_blocks_options() {
...
function stregtui_blockbuilder_render_block($key) {
