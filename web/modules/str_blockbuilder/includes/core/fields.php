...
class stregtui_bb_fields{
	...
	public function render_field_textlangs($field = array(), $value = ''){
		$_id = stregtui_blockbuilder_makeid();
	...
	public function render_field_textarea_no_html($field = array(), $value = ''){
		...
		if(isset( $field['shortcodes'] ) && $field['shortcodes']) $class .= 'gerenal_sc';
		$param 	= isset( $field['param'] ) ? $field['param'] : '';
		//$general_shortcodes = stregtui_blockbluider_general_shortcode();
		ob_start();
		?>
		<div class="textarea-wrapper <?php print $class ?>">
	...
	public function render_field_upload_imce($field = array(), $value = ''){
		global $base_url;
		$_id = stregtui_blockbuilder_makeid(10);
		$default_image = base_path() . STREGTUI_BLOCKBUILDER_PATH . '/assets/images/default.png';
		if( $value ){
		...
		<div class="gva-upload-input">
			...
			<img class="stregtui-image-demo" id="gva-upload-<?php print $_id; ?>-demo" src="<?php print $path_image_demo ?>" />
			<a class="stregtui-field-upload-remove btn-delete" data-src="<?php print $default_image ?>" style="<?php print (($value) ? 'display:inline-block;' : 'display:none;') ?>">Remove</a>
	...
	public function render_field_upload_non_imce($field = array(), $value = ''){
		...
		<div class="gva-upload-image" id="gva-upload-<?php print $_id; ?>">
			<form class="upload" id="upload-<?php print $_id; ?>" method="post" action="<?php print (base_path() . 'admin/structure/stregtui_blockbuilder/upload') ?>" enctype="multipart/form-data">
				<div class="drop">
			...
			<img class="stregtui-image-demo" src="<?php print $path_image_demo ?>" />
			<a class="stregtui-field-upload-remove btn-delete" data-src="<?php print $default_image ?>" style="<?php print (($value) ? 'display:inline-block;' : 'display:none;') ?>">Remove</a>
	...
	public function render_field_tabs($field = array(), $value = ''){
		...
		<ul class="tabs-ul">
			...
			?>
			<li class="tabs-default stregtui-hidden">
				<label>Title</label>
