...
/**
 * @file
 * Contains \Drupal\stregtui_views_magazine\Plugin\views\style\mlayout_5.
 */

namespace Drupal\stregtui_views_magazine\Plugin\views\style;
 ...
 * @ViewsStyle(
 *   id = "mlayout_5",
 *   title = @Translation("Stregtui Grid Layout"),
 *   help = @Translation("Displays Items as Grid."),
 *   theme = "views_view_mlayout_5",
 *   display_types = {"normal"}
 * )
 */
class mlayout_5 extends StylePluginBase {
