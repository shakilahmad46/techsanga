...
/**
 * @file
 * Contains \Drupal\stregtui_view\Plugin\views\style\gvaportfolio.
 */
 ...
 * @ViewsStyle(
 *   id = "gvaportfolio",
 *   title = @Translation("Stregtui Portfolio"),
 *   help = @Translation("Displays items as Stregtui Portfolio."),
