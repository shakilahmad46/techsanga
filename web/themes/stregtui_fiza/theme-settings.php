...
function stregtui_fiza_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'stregtui_fiza/stregtui-fiza-admin';  
  ...
  $form['general']['link_contact_service'] = array(
    '#type' => 'textfield',
    '#title' => t('Link contact form for service'),
    '#default_value' => theme_get_setting('link_contact_service'),
  );
  ...
  $form['options']['settings_customize']['settings'] = array(
   ...
   $form['options']['settings_customize']['settings']['theme_skin'] = array(
    ...
    '#options' => array(
      ''              => t('Default'),
      'blue'          => t('Blue'),
      'blue_one'      => t('Blue First'),
      'blue_second'   => t('Blue Second'),
      'blue_three'    => t('Blue Three'),
      'brown'         => t('Brown'),
      'downy'         => t('Downy'),
      'green'         => t('Green'),
      'lilac'         => t('Lilac'),
