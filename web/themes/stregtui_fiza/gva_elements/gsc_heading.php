         ...
         $fields = array(
            ...
            'fields'    => array(
               ...
               array(
                  ...
                  'desc'     => t('Use class icon font <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/">Icon Awesome</a> or <a target="_blank" href="http://stregtuithemes.com/icons/">Custom icon</a>'),
               ),
               array(
                  'id'        => 'align',
                  'type'      => 'select',
      ...
      public static function sc_heading( $attr, $content = null ){
         ...
         <div class="widget gsc-heading <?php print implode($class, ' ') ?>">
            <div class="heading-inner">
               ...
               <div class="sub-title">
                  <?php if($sub_title){ ?><span><?php print $sub_title; ?></span><?php } ?>
               </div>
            </div>
