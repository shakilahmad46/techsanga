      ...
      public static function sc_box_parallax( $attr, $content = null ){
         ...
         ?>
            ...
            <div class="widget gsc-box-parallax <?php print $el_class ?> content-align-<?php print $content_align ?>">
               <div class="clearfix">
                  <div class="col-first">
                     <div class="image"><img src="<?php print $image ?>" alt="<?php print stregtui_render_textlangs($title) ?>"/></div>   
                  </div>
                  <div class="col-second skrollable skrollable-between" data-bottom-top="top: -10%;" data-top-bottom="top: 30%;">
                     <div class="content-inner"  <?php print $style_content ?>>
                        ...
                        <div class="content-inner">
                           <?php if(stregtui_render_textlangs($subtitle)){ ?>
                              <div class="subtitle"><span><?php print stregtui_render_textlangs($subtitle); ?></span></div>
                           <?php } ?>  
                           <?php if(stregtui_render_textlangs($title)){ ?>
                              <div class="title"><h3><?php print stregtui_render_textlangs($title); ?></h3></div>
                            <?php } ?>    
                           <?php if(stregtui_render_textarealangs($content)){ ?>
                              <div class="desc"><?php print do_shortcode(stregtui_render_textarealangs($content)); ?></div>
                           <?php } ?>   
                           <?php if(stregtui_render_textlangs($link)){ ?>
                              <div class="readmore"><a class="btn-theme" href="<?php print stregtui_render_textlangs($link) ?>"><?php print stregtui_render_textlangs($link_title) ?></a></div>
                           <?php } ?>
                        </div>
                     </div>
                  </div> 
