   ...
   class gsc_icon_box{
         ...
         $fields = array(
            ...
            'size' => 3,'fields' => array(
               ...
               array(
                  ...
                  'title'     => t('Icon class'),
                  'std'       => '',
                  'desc'     => t('Use class icon font <a target="_blank" href="https://fontawesome.com/v4.7.0/icons/">Icon Awesome</a> or <a target="_blank" href="stregtuithemes.com/icons/">Custom icon</a>'),
               ),
               array(
                  'id'        => 'image',
                  'type'      => 'upload',
               ...
               array(
                  ...
                  'options'   => array(
                     ...
                     'text-theme-second'  => t('Text theme second'),
               ...
               array(
                  ...
                  'options'   => stregtui_blockbuilder_animate_aos(),
               ), 
               array(
                  'id'     => 'el_class',
                  'type'      => 'text',
      ...
      public static function sc_icon_box( $attr, $content = null ){
         ...
         <?php if($icon_position=='top-center' || $icon_position=='top-left' || $icon_position=='top-right' || $icon_position=='right' || $icon_position=='left'){ ?>
            <div class="widget gsc-icon-box <?php if(count($class)>0) print implode($class, ' ') ?>" <?php if(count($style) > 0) print 'style="'.implode($style, ';').'"' ?> <?php print stregtui_print_animate_aos($animate) ?>>
               ...
               <div class="highlight_content">
                ...
                <?php if(($icon || $image) && $icon_position == 'right'){ ?>
                  <div class="highlight-icon">
                     <span class="icon-container <?php print $icon_class ?>" <?php print $style_icon ?>>
                        <?php if($icon){ ?><span class="icon <?php print $icon ?>"></span> <?php } ?>
                        <?php if($image){ ?><span class="icon"><img src="<?php print $image ?>" alt="<?php print $title ?>"/> </span> <?php } ?>
                     </span>
                  </div>
               <?php } ?>
