...
if(!class_exists('gsc_info_background')):
   class gsc_info_background{
      ...
      public static function sc_info_background( $attr, $content = null ){
         ...
         $title = stregtui_render_textlangs($title);
         $content = stregtui_render_textarealangs($content);
         $link = stregtui_render_textlangs($link);
         $link_title = stregtui_render_textlangs($link_title);
