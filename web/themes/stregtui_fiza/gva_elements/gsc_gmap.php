...
if(!class_exists('gsc_gmap')):
   class gsc_gmap{
      ...
      public static function sc_gmap( $attr, $content = null ){
       ...
       ?>
      <script type="text/javascript" src="//maps.google.com/maps/api/js?sensor=true&key=AIzaSyChkvQkXo_61RR7u-XJOj-rLF9ekk9eRYc"></script>
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'stregtui_fiza')) ?>/vendor/gmap3.js"></script>
      <script type="text/javascript" src="<?php print (base_path() . drupal_get_path('theme', 'stregtui_fiza')) ?>/vendor/jquery.ui.map.min.js"></script>
