<?php
function stregtui_fiza_base_url(){
  global $base_url;
  $theme_path = drupal_get_path('theme', 'stregtui_fiza');
  return $base_url . '/' . $theme_path . '/';
}

function stregtui_fiza_preprocess_node(&$variables) {
  ...
  $variables['theme_uri'] = base_path() . drupal_get_path('theme', 'stregtui_fiza');
}

function stregtui_fiza_preprocess_node__portfolio(&$variables){
  $node = $variables['node'];
...
function stregtui_fiza_preprocess_breadcrumb(&$variables){
  ...
  if($variables['breadcrumb']){
    ...
    if(!empty($title)){
      ...
      $variables['breadcrumb'][] = array( 'text' => $title );  
    }  
  }
}